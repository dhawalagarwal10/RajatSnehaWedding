            ...
            >
              ...
              <div className="form-row">
                <label>
                  ...
                  <select
                    ...
                    onChange={(event) => {
                      ...
                      if (response === "Regretfully declines") {
                        setGuestCount("0");
                ...
                <label>
                  Number of guests
                  <span>
                    {rsvpResponse === "Regretfully declines"
                      ? "Set to 0 when declining"
                      : "Required if accepting"}
                  </span>
                  <input
                    name="entry.204303231"
                    type="number"
                    min={rsvpResponse === "Regretfully declines" ? "0" : "1"}
                    max="20"
                    required={rsvpResponse === "Joyfully accepts"}
                    readOnly={rsvpResponse === "Regretfully declines"}
                    value={
                      rsvpResponse === "Regretfully declines"
                        ? "0"
                        : guestCount
